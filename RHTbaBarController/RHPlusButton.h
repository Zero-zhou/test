...
@protocol RHPlusButtonSubclassing
...
FOUNDATION_EXTERN UIButton<RHPlusButtonSubclassing> *RHExternPlusButton;
FOUNDATION_EXTERN UIViewController *RHPlusChildViewController;

@interface RHPlusButton : UIButton
